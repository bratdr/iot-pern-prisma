...
import CardSiswa from "./pages/LoginAdmin/ManageSiswa/Card";
import PairSiswaSchool from "./pages/LoginAdmin/ManageSiswa/Pair";
...
import { BusContextProvider } from "./pages/LoginAdmin/ManageBuses/busContext";
      ...
      <Router>
        <BusContextProvider>
          <Routes>
            ...
            <Route path="/user/dashboard/:idsiswa" element={<Dashboard />} />
            <Route
              path="/user/dashboard/history/:idsiswa"
              element={<History />}
            />
